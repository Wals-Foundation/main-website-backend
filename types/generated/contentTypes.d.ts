...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    donatable: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiCauseCause extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    problem: Schema.Attribute.RichText;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCommunityCommunity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    donatable: Schema.Attribute.Relation<
      ...
      'api::donatable.donatable'
    >;
    featuredIndex: Schema.Attribute.Integer &
      Schema.Attribute.Required &
...
export interface ApiDonatableDonatable extends Struct.CollectionTypeSchema {
  collectionName: 'donatables';
  info: {
    description: '';
    displayName: 'Donatable';
    pluralName: 'donatables';
    singularName: 'donatable';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    donation: Schema.Attribute.Relation<'oneToOne', 'api::donation.donation'>;
    ...
    type: Schema.Attribute.Enumeration<
      ['community ', 'program', 'project', 'activity']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiDonationDonation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    donatable: Schema.Attribute.Relation<
      ...
      'api::donatable.donatable'
    >;
    donatedAmountInBigInteger: Schema.Attribute.BigInteger &
      Schema.Attribute.Required;
    key: Schema.Attribute.UID & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    targetAmountInBigInteger: Schema.Attribute.BigInteger &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMainMenuItemMainMenuItem
  extends Struct.CollectionTypeSchema {
  collectionName: 'main_menu_items';
  info: {
    description: '';
    displayName: 'Main Menu Item';
    pluralName: 'main-menu-items';
    singularName: 'main-menu-item';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    destination: Schema.Attribute.Relation<'oneToOne', 'api::page.page'>;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::main-menu-item.main-menu-item'
    > &
      Schema.Attribute.Private;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '';
    displayedAttribute: 'displayText';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiSocialMediaSocialMedia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accountUrl: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    icon: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
